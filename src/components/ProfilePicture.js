  ...
  return (
    <div>
      ...
      <ul className={`${!menu ? "hidden" : "" }`}> 
         <li className="w-full py-5 text-white flex justify-center font-semibold rounded-t-xl hover:bg-placeholder duration-300" onClick={routeChange} ><ProfileSVG className="w-6 h-6 mr-3"/>Profile</li>
